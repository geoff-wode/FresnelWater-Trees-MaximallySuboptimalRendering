...
namespace Idyll.SceneGraph
{
    ...
    public class Scene : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public Effect CommonParamEffect { get; private set; }
        ...
        protected override void LoadContent()
        {
            ...
            CommonParamEffect = Game.Content.Load<Effect>("Effects/CommonParameters");
        ...
        {
            CommonParamEffect.Parameters["TotalTimeMS"].SetValue((float)gameTime.TotalGameTime.TotalMilliseconds);
            CommonParamEffect.Parameters["ElapsedTimeMS"].SetValue((float)gameTime.ElapsedGameTime.TotalMilliseconds);
            ...
            CommonParamEffect.Parameters["View"].SetValue(camera.View);
            CommonParamEffect.Parameters["Projection"].SetValue(camera.Projection);
            CommonParamEffect.Parameters["CameraPosition"].SetValue(camera.Position);
        ...
        {
            GraphicsDevice.Clear(ClearOptions.DepthBuffer | ClearOptions.Target, new Color(0.3f, 0.3f, 0.5f), 1, 0);
